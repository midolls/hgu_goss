...
C {sky130_stdcells/buf_1.sym} 210 -710 0 0 {name=x3 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/buf_1.sym} 190 -450 0 0 {name=x6 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/capa.sym} 630 -680 0 0 {name=C1
m=1
value=5f
footprint=1206
device="ceramic capacitor"}
C {devices/capa.sym} 570 -440 0 0 {name=C2
m=1
value=5f
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 570 -410 0 0 {name=l1 lab=GND}
C {devices/gnd.sym} 630 -650 0 0 {name=l2 lab=GND}
C {devices/vdd.sym} 230 -390 3 0 {name=l26 lab=VDD}
C {devices/vdd.sym} 250 -570 3 0 {name=l27 lab=VDD}
