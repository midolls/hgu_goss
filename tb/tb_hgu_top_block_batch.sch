...
C {devices/vdd.sym} 790 -100 0 0 {name=l43 lab=tie_lo}
C {devices/gnd.sym} 790 20 0 0 {name=l44 lab=GND}
C {devices/res.sym} 1100 -230 0 0 {name=R9
value=1m
footprint=1206
device=resistor
m=1}
C {devices/vdd.sym} 1100 -260 0 0 {name=l45 lab=tie_lo}
...
device=resistor
m=1}
C {devices/vdd.sym} 1100 -560 0 0 {name=l20 lab=tie_lo}
...
device=resistor
m=1}
C {devices/vdd.sym} 1100 -860 0 0 {name=l34 lab=tie_lo}
...
C {devices/res.sym} 790 -10 0 0 {name=R33
value=1k
footprint=1206
device=resistor
m=1}
C {devices/vsource.sym} 790 -70 0 0 {name=V3 value=0}
C {devices/capa.sym} 760 -100 1 0 {name=C1
m=1
value=10p
footprint=1206
device="ceramic capacitor"}
