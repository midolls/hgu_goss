...
.control
	...
	foreach temp_act 0
		...
		while vdd_act le stop_vdd
			...
			alter V1 vdd_act
			run
			plot V(EXT_CLK) V(Vout) V(Vout2) V(Vout_20n) \\"async_resetb_delay_cap_ctrl_code[0]\\" \\"async_resetb_delay_cap_ctrl_code[3]\\"
...
C {devices/vsource.sym} 260 -290 0 0 {name=V1 value=1.62}
...
C {devices/noconn.sym} 720 -10 2 1 {name=l20}
C {devices/noconn.sym} 610 -10 2 1 {name=l21}
C {devices/noconn.sym} 500 -10 2 1 {name=l22}
C {devices/noconn.sym} 390 -10 2 1 {name=l24}
...
C {sky130_stdcells/buf_1.sym} -380 -780 0 0 {name=x3 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/buf_1.sym} -400 -520 0 0 {name=x6 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/capa.sym} 40 -750 0 0 {name=C1
m=1
value=5f
footprint=1206
device="ceramic capacitor"}
C {devices/capa.sym} -20 -510 0 0 {name=C2
m=1
value=5f
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} -20 -480 0 0 {name=l1 lab=GND}
C {devices/gnd.sym} 40 -720 0 0 {name=l2 lab=GND}
C {devices/vdd.sym} 250 -570 3 0 {name=l26 lab=VDD}
C {devices/vdd.sym} 230 -390 3 0 {name=l27 lab=VDD}
