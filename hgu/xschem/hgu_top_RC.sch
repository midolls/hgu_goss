...
N 2770 -380 3240 -380 {
lab=VSS}
C {hgu_sarlogic_RC.sym} 2610 -880 0 0 {name=x1}
...
C {devices/gnd.sym} 250 -980 2 0 {name=l23 lab=GND}
C {devices/gnd.sym} 250 -820 0 0 {name=l5 lab=GND}
...
C {devices/vsource.sym} 250 -850 0 1 {name=V2 value="PULSE(1.8 0.9 0 51.2u 51.2u 10p 102.4u)"}
C {devices/vsource.sym} 250 -950 2 0 {name=V4 value="PULSE(0.9 1.8 0 51.2u 51.2u 10p 102.4u)"}
...
C {devices/lab_pin.sym} 2460 -760 0 0 {name=p15 sig_type=std_logic lab=retimer_delay_cap_ctrl_code[0:3]}
...
C {devices/lab_pin.sym} 2460 -780 0 0 {name=p79 sig_type=std_logic lab=VDD}
C {devices/code.sym} 240 -620 0 0 {name=spice2 only_toplevel=false value="
...
"}
C {devices/vdd.sym} 420 -590 0 0 {name=l92 lab=VDD}
C {devices/gnd.sym} 420 -530 0 0 {name=l93 lab=GND}
C {devices/vsource.sym} 420 -560 0 0 {name=V33 value=1.8}
C {devices/vdd.sym} 470 -590 0 0 {name=l94 lab=VSS}
C {devices/gnd.sym} 470 -530 0 0 {name=l95 lab=GND}
C {devices/vsource.sym} 470 -560 0 0 {name=V34 value=0}
