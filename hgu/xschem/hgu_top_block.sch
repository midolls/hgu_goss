...
C {devices/lab_pin.sym} 2460 -880 0 0 {name=p72 sig_type=std_logic lab=sample_delay_cap_ctrl_code[0:15]}
...
C {devices/lab_pin.sym} 2460 -760 0 0 {name=p15 sig_type=std_logic lab=retimer_delay_code[0:3]}
C {devices/lab_pin.sym} 720 -820 0 0 {name=p5 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 720 -980 1 0 {name=p6 sig_type=std_logic lab=VDD}
C {devices/ipin.sym} 690 -590 0 0 {name=p74 lab=VDD}
C {devices/ipin.sym} 690 -570 0 0 {name=p78 lab=VSS}
C {devices/opin.sym} 740 -590 0 0 {name=p79 lab=result[0:7]}
C {devices/ipin.sym} 690 -490 0 0 {name=p85 lab=EXT_CLK}
C {devices/ipin.sym} 690 -540 0 0 {name=p86 lab=vip}
C {devices/ipin.sym} 690 -520 0 0 {name=p87 lab=vin}
C {devices/ipin.sym} 690 -460 0 0 {name=p118 lab=sel_bit[0:1]}
C {devices/ipin.sym} 690 -440 0 0 {name=p88 lab=sample_delay_cap_ctrl_code[0:15]}
C {devices/ipin.sym} 690 -420 0 0 {name=p89 lab=async_resetb_delay_cap_ctrl_code[0:3]}
C {devices/ipin.sym} 690 -400 0 0 {name=p90 lab=async_setb_delay_cap_ctrl_code[0:3]}
C {devices/ipin.sym} 690 -360 0 0 {name=p91 lab=async_delay_offset}
C {devices/ipin.sym} 690 -340 0 0 {name=p99 lab=sample_delay_offset}
C {devices/ipin.sym} 690 -380 0 0 {name=p100 lab=retimer_delay_code[0:3]}
C {devices/lab_pin.sym} 2460 -820 0 0 {name=p25 sig_type=std_logic lab=async_delay_offset}
...
C {devices/lab_wire.sym} 2100 -260 2 0 {name=p103 sig_type=std_logic lab=VREF}
C {/foss/designs/hgu_goss/hgu/xschem/hgu_vgen_vref.sym} 1960 -200 0 0 {name=x10}
C {devices/lab_pin.sym} 1970 -260 2 1 {name=p104 sig_type=std_logic lab=EXT_CLK}
C {devices/lab_pin.sym} 2030 -310 0 0 {name=p105 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 2030 -210 0 0 {name=p106 sig_type=std_logic lab=VSS}
